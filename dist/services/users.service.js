...
const analyticsFactory_factory_1 = __importDefault(
  require("../factory/analyticsFactory.factory")
);
class UsersService {
  ...
  createUser(newUserData) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const newUserSanitized = {
        ...
        watchedVideos: [],
        userAnalytics:
          analyticsFactory_factory_1.default.createEmptyAnalytics(),
      };
  ...
  registerUserAnalytics(userEmail, analytics) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const newAnalytics = analyticsFactory_factory_1.default.compareAnalytics(
        user.userAnalytics,
        analytics
      );
